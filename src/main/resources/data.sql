INSERT INTO
    item(id, price, name, short_description, description, img_url)
VALUES
    (1, 22.50, 'Pizza Margherita', 'Włoska pizza na cienkim cieście z serem i sosem pomidorowym',
     ...
     'ręcznie przygotowanym sosem pomidorowym i oryginalnym serem mozarella','/img/pizza-margherita.jpg'),
    (2, 25.99, 'Pizza Capriciosa', 'Pizza na cienkim cieście z serem, sosem pomidorowym i pieczarkami',
     ...
     'domowego sosu pomidorowego i oryginalnej włoskiej mozarelli znajdziesz tutaj także pieczarki i wyśmienitą sznkę.','/img/pizza-capriciosa.jpg'),
    (3, 32.99, 'Spaghetti Bolognese', 'Robiona na miejscu pasta z sosem pomidorowym i wołowiną',
     ...
     'lokalnych upraw oraz świeże zioła.','/img/spaghetti-bolognese.jpg'),
